...
Threat Level: [0-3] — [The Shire / Weathertop / Helm's Deep / The Crack of Doom]
...
- Sound the Horn of Gondor: report blockers to Gandalf immediately with options and one recommendation
- When done, light a beacon: report deliverable, validation evidence, failure modes, rollback note
- You may deploy Allies of the Free Peoples (short-lived sub-agents) for focused sorties.
  ...
  Helm's Deep+ ally deployments require Gandalf approval first.
...
- **Company** — From the Company manifest in the strategy of the council. Gives the teammate identity and signals task weight (War-band, Host, etc.).
